...
export const ar: Record<MessageKey, string> = {
  ...
  "home.heroTitle2": "مفتوحة.",
  "home.heroSubline": "منصّة العالِم لأي علم. أنشئ دورة في أمسية، اجمع متعلميك بضوء المشاعل، واحتفظ بلفائفك إلى الأبد.",
  "home.enterLibrary": "ادخل المكتبة",
  "home.inscribeYourself": "اكتب اسمك",
  "home.pillarsCartouche": "هبات تحوت الثلاث",
  "home.pillarsH2_1": "كل ما يحتاجه المعلّم.",
  "home.pillarsH2_2": "ولا شيء يزعج المتعلّم.",
  "home.underDeity": "تحت رعاية {deity}",
  "home.deity.thoth": "تحوت",
  "home.deity.seshat": "سشات",
  "home.deity.ptah": "بتاح",
  "home.pillar1.title": "أنشئ دورة في أمسية",
  "home.pillar1.body": "دروس وفيديو وملفات واختبارات تُصحَّح تلقائيًا. وحدات بالسحب والإفلات. نشر آمن من النقر المزدوج.",
  "home.pillar2.title": "اجمع متعلميك بضوء المشاعل",
  "home.pillar2.body": "غرف لكل دورة بحضور ومؤشّر كتابة وسجلّ. WebSockets تبقى حيّة عبر إعادة النشر. حذف ناعم، لا فقد للبيانات.",
  "home.pillar3.title": "احتفظ بلفائفك إلى الأبد",
  "home.pillar3.body": "ترخيص MIT، قابلة للاستضافة الذاتية. شغّل Docker compose ويُفتح المعبد. بياناتك، عتادك، لا قيود من بائع.",
  "home.scrollCartouche": "من غرفة اللفائف",
  "home.scrollH2": "ماذا ينقش الكَتَبة",
  "home.allScrolls": "كل اللفائف",
  "home.emptyTitle": "الرفوف لا تزال تُملأ.",
  "home.emptyBody": "سجّل دخولك كمدرّس لتنقش أول دورة.",
  "home.ctaTitle": "تتلمذ على يد الأساتذة.",
  "home.ctaBody": "مجانية للمتعلمين، مجانية للاستضافة الذاتية. ادفع فقط إذا أردت استضافة مُدارة ومساعدة في حدائق المعبد.",
  "home.beginApprenticeship": "ابدأ تتلمذك",
  "home.browseFirst": "تصفّح اللفائف أوّلًا",
