...
export const en = {
  ...
  "home.heroTitle2": "opened.",
  "home.heroSubline": "A scholar's platform for any discipline. Inscribe a course in an evening, gather a cohort by torchlight, keep your scrolls forever.",
  "home.enterLibrary": "Enter the library",
  "home.inscribeYourself": "Inscribe yourself",
  "home.pillarsCartouche": "Three gifts of Thoth",
  "home.pillarsH2_1": "Everything a teacher needs.",
  "home.pillarsH2_2": "Nothing a learner doesn't.",
  "home.underDeity": "Under {deity}",
  "home.deity.thoth": "Thoth",
  "home.deity.seshat": "Seshat",
  "home.deity.ptah": "Ptah",
  "home.pillar1.title": "Inscribe a course in an evening",
  "home.pillar1.body": "Lessons, video, files, and auto-graded quizzes. Drag-and-drop modules. Idempotent publishing — no fear of double-clicks.",
  "home.pillar2.title": "Gather a cohort by torchlight",
  "home.pillar2.body": "Per-course rooms with presence, typing, and history. WebSockets that stay alive through redeploys. Soft-deleted, never lost.",
  "home.pillar3.title": "Keep your scrolls forever",
  "home.pillar3.body": "MIT-licensed, self-hostable. Docker compose up and the temple opens. Your data, your hardware, no vendor altars.",
  "home.scrollCartouche": "Fresh from the scroll room",
  "home.scrollH2": "What scribes are inscribing",
  "home.allScrolls": "All scrolls",
  "home.emptyTitle": "The shelves are still being stocked.",
  "home.emptyBody": "Sign in as an instructor to inscribe the first course.",
  "home.ctaTitle": "Apprentice yourself to the masters.",
  "home.ctaBody": "Free for learners, free to self-host. Pay only if you want managed hosting and a hand in the temple gardens.",
  "home.beginApprenticeship": "Begin your apprenticeship",
  "home.browseFirst": "Browse the scrolls first",
